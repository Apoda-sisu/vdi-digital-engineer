...
/**
 * 仪控知识库检索回归测试（MCP）
 * 用法: node pilotdeck-vdi/scripts/test-instrument-knowledge-retrieval.mjs
 */
...
function mcpSearch(query, discipline = "instrument") {
  ...
  const tmp = path.join(os.tmpdir(), `vdi-instrument-kb-${Date.now()}.json`);
  try {
