...
/**
 * 管道知识库检索回归测试（MCP）
 * 用法: node pilotdeck-vdi/scripts/test-piping-knowledge-retrieval.mjs
 */
...
function mcpSearch(query, discipline = "piping") {
  ...
  const tmp = path.join(os.tmpdir(), `vdi-piping-kb-${Date.now()}.json`);
  try {
